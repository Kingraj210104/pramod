...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column mt-2">
            ...
            <a href="?page=invoices" class="nav-link <?php echo $page === 'invoices' ? 'active' : ''; ?>"><i class="fas fa-file-invoice"></i> Invoices</a>
    ...
    <header class="header d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <h5 class="mb-0 fw-bold">Hey! <?php echo isset($_SESSION['user_name']) ? $_SESSION['user_name'] : 'Vendor'; ?></h5>
        </div>
