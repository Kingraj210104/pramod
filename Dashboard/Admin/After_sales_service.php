            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card stat-card cards card-border shadow-sm" style="border-left: 5px solid #ff9933;">
                    <div class="card-body">
                        ...
                        <p class="<?php echo $open_tickets_diff_class; ?>"><?php echo htmlspecialchars($open_tickets_diff_text); ?> vs last month</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card stat-card cards card-border shadow-sm" style="border-left: 5px solid #198754;">
                    <div class="card-body">
                        ...
                        <p class="<?php echo $avg_resolution_diff_class; ?>"><?php echo htmlspecialchars($avg_resolution_diff_text); ?> vs last month</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card stat-card cards card-border shadow-sm" style="border-left: 5px solid #ffc107;">
                    <div class="card-body">
                        ...
                        <p class="<?php echo $resolved_diff_class; ?>"><?php echo htmlspecialchars($resolved_diff_text); ?> vs last week</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card stat-card cards card-border shadow-sm" style="border-left: 5px solid #6f42c1;">
                    <div class="card-body">
                        ...
                        <p class="<?php echo $satisfaction_diff_class; ?>"><?php echo htmlspecialchars($satisfaction_diff_text); ?> vs last month</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php if ($ticket_result && $ticket_result->num_rows > 0): ?>
                            <?php while ($ticket = $ticket_result->fetch_assoc()): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars('SRV-' . str_pad($ticket['ticket_id'], 3, '0', STR_PAD_LEFT)); ?></td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <button class="btn btn-outline-primary btn-sm edit-ticket-btn"
